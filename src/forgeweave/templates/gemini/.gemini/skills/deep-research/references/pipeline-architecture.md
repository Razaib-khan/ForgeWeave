...
└──────────────────┘
                   ...
                   ▼
┌──────────────────┐
│  Output Writer   │  → research/<topic>-raw/*.md
│  (1 agent)       │  Saves raw, unformatted scraped data
└──────────────────┘
                   │ raw findings
                   ▼
┌──────────────────────────────┐
│  Skill Builder (skill-builder)│  → .opencode/skills/<topic>/
│  Converts raw findings        │  Reusable SKILL.md for future coding
│  into an industry-grade skill │
└──────────────────────────────┘
```
